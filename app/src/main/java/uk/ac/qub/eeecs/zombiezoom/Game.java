...
import uk.ac.qub.eeecs.zombiezoom.engine.ScreenManager;
import uk.ac.qub.eeecs.zombiezoom.engine.audio.Music;
import uk.ac.qub.eeecs.zombiezoom.engine.graphics.CanvasRenderSurface;
import uk.ac.qub.eeecs.zombiezoom.engine.graphics.IRenderSurface;
import uk.ac.qub.eeecs.zombiezoom.engine.input.Input;
import uk.ac.qub.eeecs.zombiezoom.engine.io.FileIO;
...
public abstract class Game extends Fragment {
	...
	private class GameLoop implements Runnable {
		 ...
		 * size that will be reported to game objects (guarding them against the
		 * need to check for abnormally long frames). By default, a value of
