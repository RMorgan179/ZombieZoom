package uk.ac.qub.eeecs.zombiezoom.engine;
...
public class AssetStore {
	...
	public boolean loadAndAddBitmap(String assetName, String bitmapFile) {
		...
		try {
			...
			Log.e("ZZ", "AssetStore.loadAndAddBitmap: Cannot load ["
					+ bitmapFile + "]");
			success = false;
		}
	...
	public boolean loadAndAddMusic(String assetName, String musicFile) {
		...
		try {
			...
			Log.e("ZZ", "AssetStore.loadAndAddMusic: Cannot load [" + musicFile
					+ "]");
			success = false;
		}
	...
	public boolean loadAndAddSound(String assetName, String soundFile) {
		...
		try {
			...
			Log.e("ZZ", "AssetStore.loadAndAddSound: Cannot load [" + soundFile
					+ "]");
			success = false;
		}
