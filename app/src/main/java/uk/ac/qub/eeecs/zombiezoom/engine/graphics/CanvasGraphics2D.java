...
public class CanvasGraphics2D implements IGraphics2D {
	...
	/**
	 * Creates a new CanvasGraphics2D
	 * 
	 * @param assets
	 *            AssetManager which the CanvasGraphics2D belongs to
	 */
	 ...
	 * 
	 * @see
	 * uk.ac.qub.eeecs.zombiezoom.engine.graphics.IGraphics2D#drawBitmap(android
	 * .graphics.Bitmap, android.graphics.Rect, android.graphics.Rect,
	 ...
	 * 
	 * @see
	 * uk.ac.qub.eeecs.zombiezoom.engine.graphics.IGraphics2D#drawLine(float,
	 ...
	 * 
	 * @see
	 * uk.ac.qub.eeecs.gage.engine.graphics.IGraphics2D#clipRect(android.graphics
	 * .Rect)
	 */
	@Override
