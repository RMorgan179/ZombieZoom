...
public class BoundingBox {
	 ...
	 * 
	 * @param x
	 *            Centre x location of the box
	 * @param y
	 *            Centre y location of the box
	 * @param halfWidth
	...
	/**
	 * Return the right of the bounding box
	 * 
	 */
	 ...
	 * 
	 * @param other
	 *            Bounding box to test for intersection with this bound
	...
	public boolean intersects(BoundingBox other) {
		return (this.x - this.halfWidth < other.x + other.halfWidth
				...
				&& this.y - this.halfHeight < other.y + other.halfHeight && this.y
				+ this.halfHeight > other.y - other.halfHeight);
	}
}