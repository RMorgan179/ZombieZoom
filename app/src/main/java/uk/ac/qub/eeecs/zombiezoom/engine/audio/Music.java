...
public class Music implements OnCompletionListener {
	 ...
	 */
	protected boolean isAllowedPlay = true;
	...
	public void play() {
		if (isAllowedPlay == true) {
			...
			} catch (Exception e) { // Either IllegalStateException or
									// IOException
				String errorTag = "ZZ Error:";
				String errorMessage = "Music clip " + mAssetFile
						+ " cannot be played.";
	...
	/**
	 * Returns the flag allowing the music to play
	 * 
	 * @return isAllowedPlay
	 */
